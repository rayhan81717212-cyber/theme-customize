...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $obj = new Subject($id, $name, $class_id, $subject_code);
    $msg = $obj->update($id);
}
if (isset($_GET['id'])) {
    $res = Subject::readById($_GET['id']);
}
  ...
  <form method="post">
    <div class="card-body">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="subject_code" id="subject_code" value="<?php echo htmlspecialchars($res['subject_code']); ?>">
      </div>
    </div>
