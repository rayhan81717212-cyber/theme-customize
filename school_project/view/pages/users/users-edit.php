...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $obj = new Users($id, $name, $email, $password, $role_id, $phone, $address, $create_at);
    $msg = $obj->update($id);
}
if (isset($_GET['id'])) {
  ...
  <form method="post">
    <div class="card-body">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="create_at" id="create_at" value="<?php echo htmlspecialchars($res['create_at']); ?>">
      </div>
    </div>
