...
<div class='content-wrapper'>
  ...
  <section class='content'>
    <div class='container-fluid'>
      <a href="teacher-create" class="btn btn-primary mb-3">Add New</a>
...
<table class="table table-striped">
  ...
  <tbody>
  <?php
    $items = Teacher::readAll();
    foreach($items as $item){
      echo "<tr>";
      echo "<td>".$item['id']."</td>";
      echo "<td>".$item['name']."</td>";
      echo "<td>".$item['subject_id']."</td>";
      echo "<td>".$item['joining_date']."</td>";
      echo "<td>".$item['education_qualification']."</td>";
  ...
  ?>
    <td>
      ...
      <form action="teacher-edit" method="get">
        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
