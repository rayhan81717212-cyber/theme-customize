...
class Orders {
    ...
    public static function readAll($_skip = 0, $_limit = 5) {
        global $db;
        $sql = "SELECT o.*, os.name FROM ecom_orders o, order_status os WHERE o.order_status_id = os.id ORDER BY o.id DESC
                limit $_skip, $_limit"; 
                     // limit 5 offset 5; short form;
    ...
    public static function orderRowNo() {
        global $db;
    ...
    public static function readByPage($_page = 0, $_limit = 5) {
      $skip = ($_page - 1) * $_limit;
        global $db;
        $sql = "SELECT o.*, os.name FROM ecom_orders o, order_status os WHERE o.order_status_id = os.id ORDER BY o.id DESC
